...
window.window.data.vacancies=Array.isArray(window.window.data.vacancies)?window.window.data.vacancies:[];
window.window.data.candidates=Array.isArray(window.window.data.candidates)?window.window.data.candidates:[];
...
if(typeof extraVacancies!=='undefined')extraVacancies.forEach(v=>{if(!window.window.data.vacancies.some(x=>x.id===v.id))window.window.data.vacancies.push(v)});
if(typeof extraCandidates!=='undefined')extraCandidates.forEach(c=>{if(!window.window.data.candidates.some(x=>x.id===c.id))window.window.data.candidates.push(c)});
