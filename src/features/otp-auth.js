(function () {
  ...
  function hydrateCrossDomainSession() {
    if ((!isDemoDomain && !isAppDomain) || localStorage.getItem('teamdeck-auth') === 'logged-in') return;
