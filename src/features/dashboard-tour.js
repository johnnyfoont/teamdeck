(function () {
  ...
  const pageSteps = {
    ...
    settings: [['.title', 'Настройки', 'Здесь можно настроить рабочее пространство, язык, календарь и параметры хранения.', 'bottom'], ['.settings-grid', 'Параметры рабочего пространства', 'Настраивайте внешний вид, язык, часовой пояс и календарь.', 'bottom'], ['.security-card', 'Безопасность', 'Управляйте двухфакторной защитой, активными сессиями и резервными кодами.', 'top'], ['.backup-card', 'Резервное копирование', 'Проверяйте дату последней копии и управляйте автоматическим резервированием.', 'top']],
  };
