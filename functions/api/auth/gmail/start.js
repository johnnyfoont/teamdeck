...
export async function onRequestGet({ request, env }) {
  ...
  url.search = new URLSearchParams({ client_id: env.GOOGLE_CLIENT_ID, redirect_uri: `${appOrigin(request, env)}/api/auth/gmail/callback`, response_type: 'code', access_type: 'offline', prompt: 'consent', scope: 'openid profile email https://www.googleapis.com/auth/gmail.send', state }).toString();
